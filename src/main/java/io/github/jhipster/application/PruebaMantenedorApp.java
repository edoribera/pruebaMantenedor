...
public class PruebaMantenedorApp {

    private static final Logger log = LoggerFactory.getLogger(PruebaMantenedorApp.class);

    private final Environment env;

    public PruebaMantenedorApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes pruebaMantenedor.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PruebaMantenedorApp.class);
